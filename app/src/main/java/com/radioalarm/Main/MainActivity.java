...
import com.radioalarm.Volley.AppController;
...
public class MainActivity extends AppCompatActivity {
    ...
    String radio_url = "http://92.55.71.42:8023/live.mp3";
    ...
    private void showButtonsAnimation() {
        ...
        layout_homepage.setAlpha(0f);
        layout_homepage.setVisibility(View.VISIBLE);
        layout_homepage.animate().alpha(1f).setDuration(2500).setListener(null);

        layout_weather.setAnimation(zoomAnimation);
        layout_weather.setAlpha(0f);
        layout_weather.setVisibility(View.VISIBLE);
        layout_weather.animate().alpha(1f).setDuration(2500).setListener(null);

        layout_alarm.setAnimation(zoomAnimation);
        layout_alarm.setAlpha(0f);
        layout_alarm.setVisibility(View.VISIBLE);
        layout_alarm.animate().alpha(1f).setDuration(2500).setListener(null);

        layout_amsm.setAnimation(zoomAnimation);
        layout_amsm.setAlpha(0f);
        layout_amsm.setVisibility(View.VISIBLE);
        layout_amsm.animate().alpha(1f).setDuration(2500).setListener(null);

        layout_contact.setAnimation(zoomAnimation);
        layout_contact.setAlpha(0f);
        layout_contact.setVisibility(View.VISIBLE);
        layout_contact.animate().alpha(1f).setDuration(2500).setListener(null);

        layout_youtube.setAnimation(zoomAnimation);
        layout_youtube.setAlpha(0f);
        layout_youtube.setVisibility(View.VISIBLE);
        layout_youtube.animate().alpha(1f).setDuration(2500).setListener(null);
